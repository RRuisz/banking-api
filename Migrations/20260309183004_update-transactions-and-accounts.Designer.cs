...
namespace banking_api.Migrations
{
    ...
    [Migration("20260309183004_update-transactions-and-accounts")]
    partial class updatetransactionsandaccounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankingApi.Models.Transaction", b =>
                {
                    b.HasOne("BankingApi.Models.BankAccount", "Account")
                        .WithMany("Transactions")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BankingApi.Models.BankAccount", "TargetAccount")
                        .WithMany()
